             ...
             <div class="form-group" ><!-- form-group Starts -->
              ...
              <div class="col-md-8 offset-md-1" >
                ...
                <select name="test_id" class="form-control" >
                  ...
                  <?php 
                          $tests = $getFromScript->get_test_staff($staff_id);
            ...
            <div class="form-group" ><!-- form-group Starts -->
              ...
              <div class="form-group" ><!-- form-group Starts -->
                ...
                <div class="col-md-8 offset-md-1" >
                  ...
                  <input class="form-control" type="date" name="starting" value="" id="example-date-input">
              ...
              <div class="form-group" ><!-- form-group Starts -->
                ...
                <input class="form-control" type="date" name="ending" value="" id="example-date-input">
          ...
          <div class="row">
                       ...
                       <div class="form-group" ><!-- form-group Starts -->
                        ...
                        <div class="col-md-6 offset-md-2" >
                          ...
                          <input type="submit" name="submit" value="Schedule Test" class="btn btn-primary form-control" >
...
if(isset($_POST['submit'])){
  ...
  $sclassroom_id = $_POST['std_class_id'];
  ...
  $createScheduleTest = $getFromScript->addScheduleTest($test_id, $std_class_id, $term_id, $session_id,$duration, $starting,$ending, $staff_id);
