          ...
          <div class="card card-outline card-info">
            ...
            <div class="form-group" ><!-- form-group Starts -->
             ...
             <div class="form-group" ><!-- form-group Starts -->
                ...
                <input type="submit" name="submit" value="Create Type" class="btn btn-info form-control" >
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <td><div class="btn-group btn-group-xl">
                                                <a href="index.php?delete_test_type=<?=$columns->id;?>" class="btn btn-danger"><i class="fas fa-trash-alt"> Delete Class</i></a>
...
<?php
      ...
      if(isset($_POST['submit'])){
        ...
        $createtest_type = $getFromScript->addTest_type($name);
