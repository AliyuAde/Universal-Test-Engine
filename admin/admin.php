    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-7">
                    ...
                    <div class="card">
                        <div class="card-header">
                        <h3 class="card-title">Admin Management Table</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-responsive table-striped table-info text-center">
                                ...
                                <tbody>
                                    <?php
                                            $sn = 1;
                                            $teacher = $getFromScript->get_admins();
                                        ...
                                        <td><div class="btn-group btn-group-xl">
                                                <a href="index.php?delete_admin=<?=$columns->id;?>" class="btn btn-danger"><i class="fas fa-trash"></i></a>
...
if(isset($_POST['submit'])){
  ...
  $createadmin = $getFromScript->addAdmin($fname, $sname, $email, $staff_id, $password);
