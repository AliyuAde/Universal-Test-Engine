  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="card card-outline card-info">
            ...
            <div class="form-group" ><!-- form-group Starts -->
             ...
             <div class="form-group" ><!-- form-group Starts -->
                ...
                <input type="submit" name="submit" value="Create Session" class="btn btn-info form-control" >
      ...
      <div class="col-md-5">
                    ...
                    <div class="card">
                        <div class="card-header">
                        <h3 class="card-title">Session Management Table</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        <td><div class="btn-group btn-group-xl">
                                                <a href="index.php?delete_session=<?=$columns->id;?>" class="btn btn-danger"><i class="fas fa-trash-alt"> Delete Session</i></a>
...
if(isset($_POST['submit'])){
  ...
  $createsession = $getFromScript->addSession($name);
