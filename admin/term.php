  ...
  <div class="content-wrapper">
    ...
    <section class="content">
          ...
          <div class="card card-outline card-info">
            ...
            <div class="form-group" ><!-- form-group Starts -->
             ...
             <div class="form-group" ><!-- form-group Starts -->
                ...
                <input type="submit" name="submit" value="Create Term" class="btn btn-info form-control" >
      ...
      <div class="col-md-5">
                    ...
                    <div class="card">
                        <div class="card-header">
                        <h3 class="card-title">Term Management Table</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-responsive table-striped table-info text-center">
                                ...
                                <tbody>
                                    <?php
                                            $sn = 1;
                                            $Term = $getFromScript->get_terms();
                                            foreach($Term as $columns):
                                        ...
                                        <td><div class="btn-group btn-group-xl">
                                                <a href="index.php?delete_term=<?=$columns->id;?>" class="btn btn-danger"><i class="fas fa-trash-alt"> Delete Class</i></a>
